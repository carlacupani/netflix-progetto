...
fetch("get_genre_movie_list.php")
  ...
  .then((data) => {
    ...
    fetchDataFromServer("get_popular_movie_list.php", heroBanner);
})
...
const heroBanner = function ({ results: movieList }) {
  ...
  for (const [index, movie] of movieList.entries()) {
    ...
    btn.href = "./detail.php"; // Link ai dettagli del film
  ...
  fetchDataFromServer("get_upcoming_movie.php", createMovieList, "In uscita");
  fetchDataFromServer("get_trending_movie.php", createMovieList, "In tendenza questa settimana");
  fetchDataFromServer("get_top_rated_movie.php", createMovieList, "Più votati");
